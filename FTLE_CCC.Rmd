...
```{r, eval=FALSE}
# HFRADAR
currentNc <- gpsToHfradarDownload(gps, days=intDays, buffer=coordBuffer, name='CCC_0723')
```
...
```{r, cache=TRUE}
ftleFile <- here('CCC_0723_Results.nc')
...
# MorroWEA<-data.frame(Latitude = WEA[[2]][[3]][[1]][,2],
#                      Longitude= WEA[[2]][[3]][[1]][,1]) 
MorroWEA<-data.frame(Latitude = c(WEA[[2]][[1]][[1]][,2],WEA[[2]][[2]][[1]][,2],WEA[[2]][[3]][[1]][,2]),
                     Longitude= c(WEA[[2]][[1]][[1]][,1],WEA[[2]][[2]][[1]][,1],WEA[[2]][[3]][[1]][,1]))        

Morro1<-data.frame(Latitude = WEA[[2]][[1]][[1]][,2],
                     Longitude= WEA[[2]][[1]][[1]][,1])  

Morro3<-data.frame(Latitude = WEA[[2]][[3]][[1]][,2],
                     Longitude= WEA[[2]][[3]][[1]][,1]) 
                     
test+geom_point(data=Morro1,aes(Longitude,Latitude),col='purple',size=.4)+geom_point(data=Morro2,aes(Longitude,Latitude),col='purple',size=.4)+geom_point(data=Morro3,aes(Longitude,Latitude),col='purple',size=.4)
```
...
```{r, eval=FALSE}
plotFTLEGIF(ftle, gps=gps, title='CCC_0723', progress=TRUE, file='CCC_0723_forward.gif')
```
